...
public class Recommend{
    ...
    public String getSection1PhotoUrl() {
        return section1PhotoUrl;
    }

    public void setSection1PhotoUrl(String section1PhotoUrl) {
        this.section1PhotoUrl = section1PhotoUrl;
    }

    public String getSection2PhotoUrl() {
        return section2PhotoUrl;
    }

    public void setSection2PhotoUrl(String section2PhotoUrl) {
        this.section2PhotoUrl = section2PhotoUrl;
    }

    public String getSection3PhotoUrl() {
        return section3PhotoUrl;
    }

    public void setSection3PhotoUrl(String section3PhotoUrl) {
    ...
    public void setSection1PhotoDesc(String section1PhotoDesc) {
        this.section1PhotoDesc = section1PhotoDesc;
    }

    public String getSection2PhotoDesc() {
        return section2PhotoDesc;
    }

    public void setSection2PhotoDesc(String section2PhotoDesc) {
        this.section2PhotoDesc = section2PhotoDesc;
    }

    public String getSection3PhotoDesc() {
        return section3PhotoDesc;
    }

    public void setSection3PhotoDesc(String section3PhotoDesc) {
